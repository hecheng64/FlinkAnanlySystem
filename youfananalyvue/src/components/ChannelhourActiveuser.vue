...
<script>
  ...
  export default {
    ...
    beforeCreate:function(){
      ...
      this.$http.post('http://127.0.0.1:9082/channel/hourActivenumsMinute').then((response) => {
        this.option1 = {
          title: {
            text: '渠道分钟级小时活跃用户趋势'
          },
        ...
        this.$http.post('http://127.0.0.1:9082/channel/hourActivenumsHour').then((response) => {
          this.option2 = {
            title: {
              text: '渠道小时级小时活跃用户趋势'
            },

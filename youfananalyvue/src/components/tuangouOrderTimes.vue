...
<script>
  ...
  export default {
    ...
    beforeCreate:function(){
      ...
      this.$http.post('http://127.0.0.1:9082/tuangouInfo/orderTimesMinute').then((response) => {
        this.option1 = {
          title: {
            text: '团购成交订单分钟级点趋势'
          },
        ...
        this.$http.post('http://127.0.0.1:9082/tuangouInfo/orderTimesHour').then((response) => {
          this.option2 = {
            title: {
              text: '团购成交订单小时级趋势'
            },

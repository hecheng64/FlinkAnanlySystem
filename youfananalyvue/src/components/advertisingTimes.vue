...
<script>
  ...
  export default {
    ...
    beforeCreate:function(){
      ...
      this.$http.post('http://127.0.0.1:9082/advertising/timesMinute',{"adId": adId,"productId":productId},{emulateJSON: true}).then((response) => {
        this.option1 = {
          title: {
            text: '广告分钟级点击量趋势'
          },
        ...
        this.$http.post('http://127.0.0.1:9082/advertising/timesHour',{"adId": adId,"productId":productId},{emulateJSON: true}
        ).then((response) => {
          this.option2 = {
            title: {
              text: '广告小时级点击量趋势'

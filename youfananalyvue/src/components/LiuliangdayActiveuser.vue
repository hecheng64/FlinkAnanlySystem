...
<script>
  ...
  export default {
    ...
    beforeCreate:function(){
      ...
      this.$http.post('http://127.0.0.1:9082/liuliang/dayActivenumsMinute').then((response) => {
        this.option1 = {
          title: {
        ...
        this.$http.post('http://127.0.0.1:9082/liuliang/dayActivenumsHour').then((response) => {
          this.option2 = {
            title: {
              text: '全站流量小时级天活跃用户趋势'
            },

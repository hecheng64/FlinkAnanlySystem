...
<script>
  ...
  export default {
    ...
    beforeCreate:function(){
      ...
      this.$http.post('http://127.0.0.1:9082/huodongInfo/orderNumsMinute').then((response) => {
        this.option1 = {
          title: {
            text: '活动订单分钟级趋势'
          },
        ...
        this.$http.post('http://127.0.0.1:9082/huodongInfo/orderNumsHour').then((response) => {
          this.option2 = {
            title: {
              text: '活动订单小时级趋势'
            },

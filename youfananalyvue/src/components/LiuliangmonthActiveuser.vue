...
<script>
  ...
  export default {
    ...
    beforeCreate:function(){
      ...
      this.$http.post('http://127.0.0.1:9082/liuliang/monthActivenumsMinute').then((response) => {
        this.option1 = {
          title: {
            text: '全站流量分钟级月活跃用户趋势'
          },
        ...
        this.$http.post('http://127.0.0.1:9082/liuliang/monthActivenumsHour').then((response) => {
          this.option2 = {
            title: {
              text: '全站流量小时级月活跃用户趋势'
            },

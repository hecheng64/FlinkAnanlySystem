...
<script>
  ...
  export default {
    ...
    beforeCreate:function(){
      ...
      this.$http.post('http://127.0.0.1:9082/liuliang/hourActivenumsMinute').then((response) => {
        this.option1 = {
          title: {
            text: '全站流量分钟级小时活跃用户趋势'
          },
          yAxis: {
            title: {
              text: '小时活跃人数'
        ...
        this.$http.post('http://127.0.0.1:9082/liuliang/hourActivenumsHour').then((response) => {
          this.option2 = {
            title: {
              text: '全站流量小时级小时活跃用户趋势'
            },
            yAxis: {
              title: {
                text: '小时活跃人数'
              ...
              series: {
                ...
                events: {
                  click: function(e) {
                    ...
                    myvue.$router.push({name:'liulianguserDetail',params:{timeinfo:e.point.category}})
                  }
                }
              }
            }
